...
if __name__ == "__main__":
    ...
    def separate_and_save(src_path, dst_path, label='output', row=5, col=10, resol=80):
    ...
    base_dir = '243'
    path_L = ['test', 'test_dis_w10', 'test_dis_w100', 'test_dis_w200', 'test_dis_w400']
    f = open('quantification/fid.csv', 'w')
    f.write(',')
    ...
    for dn in range(1, 5):
        ...
        for i in tqdm(range(len(path_L))):
            ...
            if not os.path.exists(output_dir):
                ...
                separate_and_save(src_path, output_dir, 'output')
                separate_and_save(src_path, target_dir, 'target')
            fid_value = calculate_fid_given_paths([output_dir, target_dir], args.inception, low_profile=args.lowprofile)
